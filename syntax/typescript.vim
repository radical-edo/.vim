...
" }}}
"" Programm Keywords"{{{
syntax keyword typescriptSource import export from as default
...
syntax keyword typescriptLabel async readonly
syntax keyword typesciprtCase contained case
syntax region typescriptCaseExpression contained start=/case/ end=/:/ contains=typescriptCase
syntax keyword typescriptDefault contained default nextgroup=typescriptCaseColon skipwhite skipempty
syntax keyword typescriptStatement return with
syntax match typescriptCaseColon contained /:/ nextgroup=typescriptBlock skipwhite skipempty
syntax region typescriptBlock matchgroup=typescriptBraces start=/\([\^:]\s\*\)\=\zs{/ end=/}/ contains=TOP fold

syntax keyword typescriptGlobalObjects JSON Array Boolean Date Function Infinity Math Number NaN Object Packages RegExp String Symbol netscape

syntax keyword typescriptExceptions try catch throw finally Error EvalError RangeError ReferenceError SyntaxError TypeError URIError

syntax keyword typescriptReserved constructor declare interface module abstract enum int short interface static byte extends long super char final native synchronized class float package throws goto private transient debugger implements protected volatile double public type namespace get set
syntax keyword typescriptMemberAccess private public protected
syntax keyword typescriptClassConstructor constructor
"}}}
...
if version >= 508 || !exists("did_typescript_syn_inits")
  ...
  "Blue - Type Special
  "Red - Conditional Repeat Statement Keyword Operator
  "Green - Function Exception
  "Orange - Identifier
  "Purple - Constant Number
  "Beige - Label
  ...
  "HiLink typescriptEndColons Type
  "HiLink typescriptBraces Operator
  ...
  HiLink typescriptInterpolationDelimiter Special
  HiLink typescriptRegexpString Special
  ...
  HiLink typescriptFuncKeyword Special
  ...
  HiLink typescriptReserved Special
  HiLink typescriptMemberAccess Keyword
  HiLink typescriptClassConstructor Identifier
